...
{
      14,     0,    -1,    15,     6,    -1,    12,     6,    -1,    15,
       8,    16,    -1,    16,    -1,    17,    -1,    18,    17,    -1,
       4,    -1,     3,    -1,    19,     9,    -1,     5,    -1
};
...
{
  "$end", "error", "$undefined", "COMENTARIO", "BOOLEANO", "IDE", "NL", 
  "BOOLEANEXPRESION", "PCOMA", "DP", "IDENT", "NUM", "EXIT", "$accept", 
  "Assertion", "HELP", "ASSERTIONCLAUSE", "UNLABELEDASSERTIONCLAUSE", 
  "TANGMARK", "TAG", 0
};
#endif
...
{
       1,     2,     3,     1,     2,     3,     1,     2,    13,     4,
      14,    11,    12,    16,     0,    17,    15
};

static const yysigned_char yycheck[] =
{
       3,     4,     5,     3,     4,     5,     3,     4,     6,    12,
       8,     6,     0,     9,    -1,    14,     9
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 13 "Sintactica.y"
    {printf("*** LA CADENA ES VALIDA ***"); tablahelp(); arbolacion(); yyparse();;}
    break;

  case 3:
#line 14 "Sintactica.y"
    {yywrap();;}
    break;
